...
class DMCWrapper(core.Env):
    def __init__(
        ...
        # background
        img_source = None   # comment this line to use background
    ...
    def _get_obs(self, time_step):
        if self._from_pixels:
            ...
            self._img_source = None # comment this line to use background
    ...
    def reset(self):
        ...
        #self._bg_source.reset()    # comment this line to use background
        obs = self._get_obs(time_step)
        return obs
